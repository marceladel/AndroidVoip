			  ...
			  implements Handler.Callback, MyAppObserver
{
	...
	if (app.accList.size() == 0) {
	    ...
	    accCfg.setIdUri("sip:2020304002@104.239.166.30");
...
//	    	Intent goToSettingsPage= new Intent(getApplicationContext(), SipSettingsActivity.class);
//	    	startActivity(goToSettingsPage);
    ...
    /* this function responsible for config sip */
	...
	etReg.setText("sip:104.239.166.30");
	etUser.setText("2020304002");
	etPass.setText("2602");
	...
	adb.setPositiveButton("OK",
		...
		public void onClick(DialogInterface dialog,int id)
		{
		    ...
		    Log.d("values", "id is:" + acc_id + " " + "registrar is: "
					+ registrar + " " + "username is :" + username + " "
